        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {filteredProjects.map((project, idx) => (
            <motion.div
              ...
              className="group flex flex-col rounded-2xl bg-[#111C30]/80 border border-slate-800 hover:border-slate-700/90 overflow-hidden backdrop-blur-md shadow-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl"
            >
              {/* Thumbnail Container */}
              <div className="relative aspect-video w-full overflow-hidden bg-slate-900">
                ...
                <div className="absolute inset-0 bg-[#0B1120]/60 backdrop-blur-xs opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                  <button
                    ...
                    className="px-3.5 py-2 rounded-xl bg-amber-400 text-slate-950 font-semibold text-xs flex items-center gap-1.5 shadow-lg transform translate-y-2 group-hover:translate-y-0 transition-transform cursor-pointer"
                  >
                  ...
                  {project.liveUrl && (
                    <a
                      ...
                      className="p-2 rounded-xl bg-slate-800/90 text-slate-200 hover:text-white border border-slate-700 shadow-lg transform translate-y-2 group-hover:translate-y-0 transition-transform cursor-pointer"
                      title="Visit Site"
                    >
